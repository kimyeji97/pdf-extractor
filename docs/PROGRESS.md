...
| REQ-D10 | 문항 목록 n×n 바둑판 배열 — 임계 420px 초과 시에만 열 수 증가(D01과 공존) | [plan](plans/PLAN-D10-question-grid-columns.md) | — | 🟡 **Phase 1 완료**(케이스 7/7 · `/testrun` 확인 · `feat/D10-question-grid-columns` `0a4e788`, 미머지). Phase 2(로컬 육안 검증) 남음 |
